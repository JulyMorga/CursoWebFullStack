...
console.log(x); // 6 Recién acá se implementa el incremento
console.log("El valor inicial de y es: " + y); // 2
console.log("El valor de y-- es: " + y--); // 2
console.log(y); // 1 Recién acá se implementa el decremento
console.log("El valor de y-- es: " + --y); // 0  Primero decrementa y despues muestra.
...
console.log(typeof tipoNumerico);		// number
console.log(typeof tipoBooleano);		// boolean
console.log(typeof tipoString);			// string
console.log(typeof tipoUndefined);		// undefined
