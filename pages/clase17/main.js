...
console.log("--------- map()  ----------")
console.log("Se ejecuta por cada elemento del array, y crea un nuevo array a partir del resultado de cada ejecución por elemento.")
...
console.log("--------- filter()  ----------")
console.log("Se ejecuta por cada elemento de array, y crea un nuevo array con los elementos que cumplen cierta condición.")
...
// REDUCE
// Es una función que se va a ejecutar para cada elemento del array y luego devolver un único valor conocido como acumulado. Se podría utilizar cuando necesitas acumular cosas


let elemento10 = document.querySelector("h1");
elemento10.innerText = elemento10.innerText.substring(0,11) + " con substring.";
